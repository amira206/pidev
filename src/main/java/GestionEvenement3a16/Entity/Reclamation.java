...
public class Reclamation {
    ...
    public Reclamation(int id, String nom, String prenom, String email, int numTele, String etat, String sujet, String description, LocalDateTime date, Reponse reponse, User utilisateur) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
    ...
    public static Reclamation getReclamation(int id) {

...
public class Login {
    ...
    void Login(ActionEvent event) {
        ...
        try {
            ...
            if (loggedInUser != null) {
                ...
                }else if (loggedInUser.getRole() == Role.PASSAGER){
                    redirectToFront(event);
                }
    ...
    private void redirectToFront(ActionEvent event) {
        try {
            // Redirection vers l'interface admin
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GestionEvenement3a16/Frontview.fxml"));
            Parent root = loader.load();
            Scene scene = new Scene(root);
            Stage stage = (Stage) ((javafx.scene.Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
    ...
    private void redirectToBack(ActionEvent event) {
        try {
            // Redirection vers l'interface admin
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GestionEvenement3a16/Dash.fxml"));
            Parent root = loader.load();
            Scene scene = new Scene(root);
            Stage stage = (Stage) ((javafx.scene.Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
